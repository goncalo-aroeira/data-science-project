...
\begin{figure}[H]
\centering\includegraphics[scale=0.5]{images/dataset2/time_series/fts_forecast_ts_FirstDerivative.png}
\includegraphics[scale=0.5]{images/dataset2/time_series/fts_forecast_ts_SecondDerivative.png}
