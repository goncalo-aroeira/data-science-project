...
\begin{figure}[H]
\centering\includegraphics[scale=0.8]{images/dataset2/time_series/fts_boxplot.png}
\caption{Boxplot(s) for time series 2}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.60]{images/dataset1/time_series/Covid_distribution_histogram.png}
