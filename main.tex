...
\ctext[RGB]{190,190,190}{
  Minimal preprocessing was done. We addressed errors such as converting the \textit{Age} 
  variable to numeric by removing "\_" in the services dataset. 
  \par 
  Anomalies, like outliers, were retained for profiling.
