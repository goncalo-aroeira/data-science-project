...
\begin{figure}[H]
%\centering\includegraphics[scale=0.95]{images/dataset1/data_profiling/Credit_Score}
...
\includegraphics[scale=0.95]{images/dataset2/models_evaluation/Credit_Score_knn_KNN_best_accuracy_eval.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset2/models_evaluation/Credit_Score_DT_best_tree.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset1/models_evaluation/CovidPos_rf_recall_vars_ranking.png}
\includegraphics[scale=0.95]{images/dataset2/models_evaluation/Credit_Score_rf_accuracy_vars_ranking.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset1/models_evaluation/CovidPos_gb_recall_vars_ranking.png}
\includegraphics[scale=0.95]{images/dataset2/models_evaluation/Credit_Score_gb_accuracy_vars_ranking.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset1/time_series/Covid_granularity_aggregation_W.png}
\caption{Time series 1 at the most granular detail}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset1/time_series/Covid_granularity_aggregation_M.png}
\caption{Time series 1 at the second chosen granularity}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset1/time_series/Covid_granularity_aggregation_Q.png}
\caption{Time series 1 at the third chosen granularity}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset2/time_series/fts_granularity_min.png}
\caption{Time series 2 at the most granular detail}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{dataset2/images/ts_analysis/fts_granularity_H.png}
\caption{Time series 2 at the second chosen granularity}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{dataset2/images/ts_analysis/fts_granularity_D.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.60]{dataset1/time_series/Covid_distribution_histogram.png}
\caption{Histogram(s) for time series 1}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.60]{images/dataset2/time_series/fts_histogram.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset2/time_series/fts_linear_regression_forecast_Minutely.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset2/time_series/fts_linear_regression_eval_Minutely.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset2/time_series/fts_forecast_ts_after_smooth_ws_25.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{images/dataset2/time_series/fts_forecast_eval_after_smooth_ws_25.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.5]{images/dataset2/time_series/fts_simpleAvg_forecast.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.5]{images/dataset2/time_series/fts_arima_R2_forecast.png}
...
\ctext[RGB]{190,190,190}{For Dataset 1, having a trend, the LSTM excels with parameters length=4, hidden=100 and nr_episodes=900, effectively capturing trend-oriented patterns. This adaptability extends to Dataset 2, featuring a cosine-like trend, where the same parameter configuration yields optimal results. As expected the LSTM's model achieves the best forecasting results for both datasets compared to the previous models.}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.5]{images/dataset2/time_series/fts_lstms_R2_forecast.png}
