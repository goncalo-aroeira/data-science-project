...
\begin{center}
    ...
    \begin{tabular}{ |l|l l|l| }
        \hline
        \multirow{4}{6em}{\textbf{Team nr: } Insert here} & \textbf{Student 1: } Gonçalo Gonçalves & \textbf{IST nr: }Insert here\\
        & \textbf{Student 2: } José Cruz & \textbf{IST nr:} 99260 \\
        & \textbf{Student 3: } Jorge Santos & \textbf{IST nr: }Insert here \\
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{ds_latex/images/Credit_Score_records_variables.png}
\caption{Nr Records x Nr variables for dataset 1 (left) and dataset 2 (right)}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{ds_latex/images/Credit_Score_variable_types.png}
\caption{Nr variables per type for dataset 1 (left) and dataset 2 (right)}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[scale=0.95]{ds_latex/images/Credit_Score_mv.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{ds_latex/images/Credit_Score_global_boxplot_modified.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.6]{ds_latex/images/Credit_Score_single_boxplots.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.6]{ds_latex/images/Credit_Score_single_histograms_numeric.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.8]{ds_latex/images/Credit_Score_outliers_standard.png}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.95]{ds_latex/images/Credit_Score_class_distribution.png}
